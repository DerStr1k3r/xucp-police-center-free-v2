...
/*************************************************************/
// ReDesign          : [url]https://DerStr1k3r.com[/url]
/*************************************************************/
var textarea;
var content;
...
function edToolbar(obj, url, png) {
    ...
    document.write("<div class=\"card\">\n" +
        "  <div class=\"card-body align-self-center button-items\">\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-cross\" name=\"btnBold\" onClick=\"doRemoveTags('" + obj + "')\"></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-clipboard\" id=\"popFont\" src=\"" + url + "/menupop." + end + "\" onClick=\"showpopup('font','popFont')\"></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-skip\" src=\"" + url + "/menupop." + end + "\" id=\"popSize\" onClick=\"showpopup('size','popSize')\" ></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-bold\" src=\"" + url + "/bold." + end + "\" name=\"btnBold\" onClick=\"doAddTags('[b]','[/b]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-italic\" src=\"" + url + "/italic." + end + "\" name=\"btnItalic\" onClick=\"doAddTags('[i]','[/i]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-view-list\" src=\"" + url + "/underline." + end + "\" name=\"btnUnderline\" onClick=\"doAddTags('[u]','[/u]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-code\" src=\"" + url + "/pre." + end + "\" name=\"btnPre\" onClick=\"doAddTags('[pre]','[/pre]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-code\" src=\"" + url + "/pre." + end + "\" name=\"btnPre\" onClick=\"doAddTags('[pre]','[/pre]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-swap\" src=\"" + url + "/center." + end + "\" name=\"btnLink\" onClick=\"doAddTags('[center]','[/center]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-link\" src=\"" + url + "/link." + end + "\" name=\"btnLink\" onClick=\"doURL('" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-link-broken\" src=\"" + url + "/unlink." + end + "\" name=\"btnunLink\" onClick=\"doRemoveURL('" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-photo\" src=\"" + url + "/image." + end + "\" name=\"btnPicture\" onClick=\"doImage('" + obj + "')\" /></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-list\" src=\"" + url + "/orderedlist." + end + "\" name=\"btnList\" onClick=\"doList('[list=1]','[/list]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-list\" src=\"" + url + "/unorderedlist." + end + "\" name=\"btnList\" onClick=\"doList('[list]','[/list]','" + obj + "')\" \/></i></div>\n" +
        "    <div class=\"btn btn-secondary\"><i class=\"dripicons-message\" src=\"" + url + "/quote." + end + "\" name=\"btnQuote\" onClick=\"doAddTags('[quote]','[/quote]','" + obj + "')\" \/></i></div>\n" +
        "  </div>\n" +
        "</div>");
