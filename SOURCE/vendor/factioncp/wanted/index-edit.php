            ...
            try
            {
                if(!isset($errorMsg))
                {
                    ...
                    if($insert_stmt->execute(array(	':xucp_file_number'	=>$file_number,
                        ...
                        header("refresh:2; /vendor/factioncp/wanted/index.php");
                    }
                }
            }
    ...
    echo "
                    ...
                    <div class='row'>
                        <div class='col-xl-12'>
                            <div class='card'>
                                <div class='card-body'>
									<form action='/vendor/factioncp/wanted/index-edit.php?id=".$id."' method='post' enctype='multipart/form-data'>
										<tr>				  
											<td>
												<h6>
													".WANTED_FILE_NUMBER."
										...
										<tr>				  
											<td>
												...
												<div class='input-group'>";
                                                    xucp_pol_text_bbcode('xucp_msg', htmlspecialchars(stripslashes($row['msg'])));
                                                echo "
												</div>	
											</td>
										</tr>
