...
xucp_pol_head_logged("fas fa-car",TRAIN_ADD_EDIT);
xucp_pol_navi_logged();
xucp_pol_content_logged("fas fa-car",TRAIN_ADD_EDIT);

$id = $_GET['id'];
$select_stmt = $db->prepare(query: "SELECT * FROM xucp_police_patrolduty WHERE id = ".$id);
$select_stmt->execute();
            ...
            try
            {
                if(!isset($errorMsg))
                {
                    $insert_stmt=$db->prepare("UPDATE 
                                                ...
                                                SET
                                                    `pduty_number` = :xucp_pduty_number, 
                                                    `pduty_unit_1` = :xucp_pduty_unit_1, 
                                                    `pduty_unit_2` = :xucp_pduty_unit_2
                                                WHERE 
                                                    `id` = ".$id);
                    ...
                    if($insert_stmt->execute(array(	':xucp_pduty_number'	=>$pduty_number,
                        ...
                        header("refresh:2; /vendor/factioncp/patrolduty/index.php");
                    }
                }
            }
							...
							<div class='col-xl-12'>
								<div class='card'>
									<div class='card-header'>
										<h4 class='card-title'>".PDUTY_ADD_EDIT.": " . $row["pduty_number"]. "</h4>
									</div>
									<div class='card-body'>
										".$error."
									</div>
                            ...
                            <div class='col-12'>
                                <div class='card'>
                                    ...
                                    <div class='card-body p-4'>
										<form action='/vendor/factioncp/patrolduty/index-edit.php?id=".$id."' method='post' enctype='multipart/form-data'>
                                        <div class='row'>
                                            <div class='col-lg-12'>
                                                <div>
                                                    <div class='mb-3'>
                                                        <label for='example-text-input' class='form-label'>".PDUTY_ADD_PERSONS."</label>
														<input class='form-control' type='text' name='xucp_pduty_number' value='" . $row["pduty_number"]. "' id='example-text-input'>
                                                    </div>                                                   
                                                </div>
                                            </div>
                                            <div class='col-lg-12'>
